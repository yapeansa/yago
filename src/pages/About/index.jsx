        ...
        <div id="sobre">
            <Secao corDeFundo="var(--preto)">
                <Container>
                    ...
                    <AboutInfo>
                        <p>Olá, eu me chamo Yago Pereira e tenho {idade()} anos. Em 2021 adquiri o título de bacharel em Matemática pela <a href="http://ufjf.br" title="Universidade Federal de Juiz de Fora" target="_blank">UFJF</a> e atualmente sou discente do curso de Mestrado Acadêmico em Matemática nesta mesma instituição. Desde a adolescência possuo um fascínio por tecnologia em geral, o que me levou no decorrer do tempo a estudar as linguagens <span className="estilizado">HTML</span> e <span className="estilizado">CSS</span> como autodidata. Me aperfeiçoei ainda mais nestas linguagens na intituição de ensino <a href="https://www.alura.com.br" target="_blank">Alura</a> e isso me levou a conhecer, de modo a me aprofundar, na linguagem <span className="estilizado">Javascript</span> e, além disso, a mergulhar no framework <span className="estilizado">React</span>.</p>
